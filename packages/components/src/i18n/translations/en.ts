export const en = {
  ...
  connect_account_info: `Period Tracker App is in offline mode so information you record is being stored on your phone. To avoid losing this information if you lose or change phones, connect to the internet and tap Save Account.`,
  ...
  notification_2_title: 'Your Period Tracker App buddy misses you! ',
  notification_2_body:
    'By using your Daily Diary every day, Period Tracker App can make better predictions 🤓',
  notification_3_title: 'Did you know?',
  notification_3_body:
    'You can use Period Tracker App to become a boss when it comes to facts about your body! ',
  ...
  notification_6_body:
    'Is it true that cold food gives you cramps?😳 Find out the answer in the Period Tracker App encyclopedia!',
  ...
  the_facts: `The facts`,
  friend: 'Your Period Tracker App buddy',
  friends_onboard: `Friendly characters guide you through the app!`,
  continue: 'continue',
  welcome_heading: `Welcome to Period Tracker App!`,
  i_agree: 'I agree',

  // ------------------------- Settings ----------------------------
  settings: 'Settings',
  join_oky_message: 'Join Period Tracker App and stay informed',
  settings_info: 'Choose language, access a tutorial or share Period Tracker App with a friend',
  access_setting: 'Access Settings',
  about: 'About',
  about_info: 'Find out more about Period Tracker App',
  t_and_c: 'Terms & Conditions',
  t_and_c_info: `What you agree to by using Period Tracker App`,
  privacy_info: `How Period Tracker App stores, shares and protects the information you give`,
  share_setting: 'Share',
  language: 'Language',
  choose_language: 'Change the language Period Tracker App uses:',
  language_subtitle: 'Change the language Period Tracker App uses:',
  en: 'English (global)',
  id: 'Indonesia',
  mn: 'Mongolia',
  tutorial: 'Tutorial',
  tutorial_subtitle: 'Get instructions on how to use Period Tracker App',
  tutorial_0: `Hi! I'm your friend. I'm here for you every step of the way! To show me love, give me a tap! Now, let me give you a quick tour of Period Tracker App.`,
  ...
  tutorial_11: `On the other cards, track your mood, flow, body and activities. Do it every day to win Period Tracker App stars!`,
  ...
  share_qr_description: 'Share Period Tracker App with your friends!',
  ...
  delete_account_description:
    'Deleting your account will mean all the information you recorded on Period Tracker App will be deleted as well.',
  logout_account_description:
    'As a guest user, all the information you gave Period Tracker App will not be saved when you log out.\n\nTap Save Account in your profile to save it now!',
  ...
  survey_default_answer_1_1: `Ok! In that case Period Tracker App can help you track and predict your periods.`,
  survey_default_answer_1: `That's ok! You can still use Period Tracker App to learn about periods and feel confident when the time comes.`,
  survey_default_answer_2: `No problem! That's why Period Tracker App's here to help you keep track! For now, let's say it was about 2 weeks ago. You can change it later if you want to.`,
  ...
  survey_default_answer_4: `No problem! Period Tracker App can help you track this. There's usually a 3 week gap between your periods, so let's say this for now. You can make this more accurate once you start tracking!`,
  ...
  fertile_popup: `Period Tracker App uses the information you give to make predictions about your period days and your ovulation time. But it is information only, and not a reliable prediction of your fertile days.`,
  ...
  // ---------------------settings content-----------------------
  about_heading_1: `What is Period Tracker App? \n`,
  about_heading_2: `Why did Organization create Period Tracker App? \n`,
  about_heading_3: `How did Organization create Period Tracker App? \n`,
  about_heading_4: `How does Period Tracker App work?\n`,
  about_heading_5: `How is Period Tracker App different?\n`,

  about_content_1: `Period Tracker App is a mobile phone app that helps girls to take control of their periods and their lives. Feel more confident by tracking your period, and getting the facts that all girls should know.\n`,
  about_content_2: `Period Tracker App is a period tracking app designed for girls and by girls: it's fun and positive because we want to reverse the shyness and bad feelings that periods can sometimes cause! \n`,
  about_content_3: `Organization created Period Tracker App as part of its mission to promote girl’s education and health, by changing one of the world’s biggest taboos: menstruation. \n \n`,
  ...
  about_content_6: `We spent months talking to more than 400 girls in Mongolia and Indonesia about their periods, their fears, their hopes and their lives, and worked together to co-create Period Tracker App! Of course, we also worked with our education and medical experts to ensure that Period Tracker App reflect Organization’s ethics and its high health standards and guidelines.  \n \n`,
  about_content_7: `Period Tracker App allows you to add information about your period, body, activities and mood, and based on this, provides predictions about you next period and ovulation cycle. There is a calendar, which acts as a diary and helps with reminders. Period Tracker App gives tips and motivation through games & quizzes too!\n\n`,
  about_content_8: `Period Tracker App is different from other period tracking apps because it is aimed particularly at girls. Period Tracker App is not a business, it is a service for girls that aims to be inclusive and non-judgemental, and maintains the highest privacy and data protection standards.\n \n `,
...
Last updated: 16th October 2019`,
  ...
  t_and_c_heading_2: `By using Period Tracker App you accept these terms. If you do not agree to these terms, you must not use Period Tracker App.\n`,
  ...
  t_and_c_heading_16: `Organization name and emblem\n`,

  t_and_c_content_1: `Period Tracker App is a way to monitor and learn about your menstrual cycle, as well as provide information  about your period and female health. The service is provided for free. \n\n
PLEASE DO NOT USE “Period Tracker App” FOR CONTRACEPTIVE OR MEDICAL PURPOSES. IN CASE OF ANY INDIVIDUAL HEALTH ISSUES, CONSULT A MEDICAL PROFESSIONAL.\n\n`,
  t_and_c_content_2: `Period Tracker App  is not intended to replace contraceptive measures and/or medical advice: it is only intended to provide information. By using Period Tracker App you agree to use it for the intended purpose only and particularly not for contraception and/or medical purposes.\n\n`,
  t_and_c_content_3: `Period Tracker App provides general informational content about female health, menstruation, fertility and related topics. It collects data that is entered by   users related to their menstrual cycle, physical activities, health and bodies. \n \n
...
These combined data points allow the app to make associations and identify patterns between events related to the menstrual cycle and female health using simple mathematical/statistical formulas and algorithm-based calculations.\n\n`,
  ...
  t_and_c_content_5: `Although Organization makes reasonable efforts to update the information on Period Tracker App, we make no representations, warranties or guarantees, whether express or implied, that the content on Period Tracker App is accurate, complete or up to date.\n\n`,
  t_and_c_content_6: `Organization amends these terms from time to time. Every time you wish to use Period Tracker App, please check these terms to ensure you understand the terms that apply at that time.\n\n`,
  t_and_c_content_7: `Organization may update and change Period Tracker App from time to time to provide updated information, links or provide new functionality and reflect changes to our users' needs.\n\n`,
  t_and_c_content_8: `Period Tracker App is available free of charge. Organization does not guarantee that Period Tracker App, or any content on it, will always be available or be uninterrupted. We may suspend or withdraw or restrict the availability of all or any part of Period Tracker App for operational or other reasons. We will try to give you reasonable notice of any suspension or withdrawal.\n\n`,
  t_and_c_content_9: `If anyone else uses Period Tracker App through your device, you are also responsible for ensuring that they are aware of these terms of use and other applicable terms and conditions, and that they comply with them.\n\n`,
  t_and_c_content_10: `If you choose, or you are provided with, a user identification code, password or any other piece of information as part of Organization security procedures, you must treat such information as confidential. You must not disclose it to any third party.\n\n`,
  t_and_c_content_11: `Organization has the right to disable any user identification code or password, whether chosen by you or allocated by us, at any time, if in our reasonable opinion you have failed to comply with any of the provisions of these terms of use.\n\n`,
  t_and_c_content_12: `By using Period Tracker App, you agree that the location you provide when signing up is accurate. \n \n`,
  t_and_c_content_13: `Period Tracker App may link to other websites and resources that are not under Organization's control. The inclusion of such links does not imply an endorsement or approval by Organization of any website, product or service.\n\n`,
  t_and_c_content_14: `Organization does not assume any responsibility or liability in respect of such websites, including, for example, responsibility or liability for the accuracy or reliability of any information, data, opinions, advice or statements made on those web sites.\n`,
